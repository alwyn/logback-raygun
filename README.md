...
**NB. This specific repository and version is based on the original work of Greg Kopff.  This incarnation is a Kotlin port with some modifications necessary to support the latest Raygun Java API.**

A logback appender that emits details to [raygun.io](http://raygun.io/).  It requires Java 11+ and the Kotlin runtime libraries 1.5.21+.

## Getting it

````
<dependency>
  <groupId>tech.nomads.logback-raygun</groupId>
  <artifactId>logback-raygun</artifactId>
  <version>3.0.0</version>
</dependency>
````
This project currently doesn't have a proper POM for publishing and as such you need to add the raygun and logback dependencies yourself.

## Configuration

````
<configuration>
  <appender name="RAYGUN" class="tech.nomads.raygun.RaygunAppender">
